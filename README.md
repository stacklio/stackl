...
STACKL was first created for in-house use by a DevOps company, [Nubera](https://www.nubera.eu/), who identified some missing tools that would be handy to better provide services to clients. Due to STACKL's usefulness, it quickly became clear it could be useful as an open-source project for the DevOps community.
