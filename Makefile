...
.PHONY: openapi
openapi:
	openapi-generator generate -i http://localhost:8080/openapi.json -g python -t build/openapi-generator --package-name stackl_client --additional-properties=packageVersion=${VERSIONTAG} -o /tmp/stackl-client
