...
def apply(directory, config_file, params, tags, secrets, service_params,
          replicas, services, instance_name, show_progress):
    ...
    if instance_name is None:
        ...
        apply_stack_instance(config_file, params, tags, secrets,
                             service_params, replicas, services,
                             stackl_context, instance_name, show_progress)


def apply_stack_instance(config_file, params, tags, secrets, service_params,
                         replicas, services, stackl_context, instance_name,
                         show_progress):
    final_params = {}
    for item in params:
