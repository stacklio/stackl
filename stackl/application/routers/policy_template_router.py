...
@router.put('/policy')
def put_policy_template(ppolicy_template: PolicyTemplate):
    opa_broker.add_policy(ppolicy_template.name, ppolicy_template.policy)
    result = document_manager.write_policy_template(ppolicy_template)
    return result
