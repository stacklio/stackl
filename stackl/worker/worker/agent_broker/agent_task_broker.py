...
from worker.message_channel.message_channel import MessageChannel

logger = logging.getLogger("STACKL_LOGGER")


class AgentTaskBroker:
    def __init__(self, message_channel: MessageChannel):
    ...
    def create_job_for_agent(self, stack_instance, action, document_manager,
        ...
        for service in stack_instance.services:
            ...
            for fr in service_doc["functional_requirements"]:
                ...
                for service_definition in stack_instance.services[
                        service_name]:
                    ...
                    self.message_channel.send_agent_task(
                        agent_task, "stackl_jobs", infrastructure_target)
