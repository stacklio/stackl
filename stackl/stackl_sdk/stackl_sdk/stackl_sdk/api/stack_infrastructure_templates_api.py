...
class StackInfrastructureTemplatesApi(object):
    ...
    def delete_stack_infrastructure_template(self, document_name, type_name, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.delete_stack_infrastructure_template_with_http_info(document_name, type_name, **kwargs)  # noqa: E501
            return data
    ...
    def delete_stack_infrastructure_template_with_http_info(self, document_name, type_name, **kwargs):  # noqa: E501
        ...
        if ('document_name' not in params or
            ...
            raise ValueError("Missing the required parameter `document_name` when calling `delete_stack_infrastructure_template`")  # noqa: E501
        # verify the required parameter 'type_name' is set
        if ('type_name' not in params or
                params['type_name'] is None):
            raise ValueError("Missing the required parameter `type_name` when calling `delete_stack_infrastructure_template`")  # noqa: E501
    ...
    def get_stack_infrastructure_template_by_name(self, document_name, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_stack_infrastructure_template_by_name_with_http_info(document_name, **kwargs)  # noqa: E501
            return data
    ...
    def get_stack_infrastructure_template_by_name_with_http_info(self, document_name, **kwargs):  # noqa: E501
        ...
        if ('document_name' not in params or
                params['document_name'] is None):
            raise ValueError("Missing the required parameter `document_name` when calling `get_stack_infrastructure_template_by_name`")  # noqa: E501
    ...
    def get_stack_infrastructure_templates(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_stack_infrastructure_templates_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def post_stack_infrastructure_template(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_stack_infrastructure_template(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param StackInfrastructureTemplate body: (required)
        :return: StackInfrastructureTemplate
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_stack_infrastructure_template_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_stack_infrastructure_template_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def post_stack_infrastructure_template_with_http_info(self, body, **kwargs):  # noqa: E501
        """Post Stack Infrastructure Template  # noqa: E501

        Create the document with a specific type and an optional name given in the payload  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_stack_infrastructure_template_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_stack_infrastructure_template`")  # noqa: E501
    ...
    def put_stack_infrastructure_template(self, body, **kwargs):  # noqa: E501
        """Put Stack Infrastructure Template  # noqa: E501

        Create the document with a specific type and an optional name given in the payload  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_stack_infrastructure_template(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_stack_infrastructure_template_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.put_stack_infrastructure_template_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def put_stack_infrastructure_template_with_http_info(self, body, **kwargs):  # noqa: E501
        """Put Stack Infrastructure Template  # noqa: E501

        Create the document with a specific type and an optional name given in the payload  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_stack_infrastructure_template_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_stack_infrastructure_template`")  # noqa: E501
