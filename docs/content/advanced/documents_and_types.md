...
**Policy**
: service- and application-level requirements that specify additional requirements on the the service or applications, such as rendunacy requirements, service latency links, availability conditions, ...
